...
parser.add_argument('--xtx-override', default=False, action='store_true',
    help='Indicates whether to use speed up by calculating all xtx/xty at once prior to regression')
...
if __name__ == '__main__':
    ...
    try:
        ...
        # summary statistics
            ...
            if (args.h2 is not None) and args.xtx_override is None:
                raise ValueError('--xtx-override can only be used with --h2')
